(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? factory(exports, require("gpu.js"))
    : typeof define === "function" && define.amd
    ? define(["exports", "gpu.js"], factory)
    : ((global =
        typeof globalThis !== "undefined" ? globalThis : global || self),
      factory((global.brain = {}), global.GPU));
  ...
  class CrossValidate {
    ...
    fromJSON(crossValidateJson) {
      const winningJSON = crossValidateJson.sets.reduce((prev, cur) =>
        prev.error < cur.error ? prev : cur
      );
  ...
  CrossValidate.isBinaryPartitionResults = (stats) =>
  ...
  class MeanSquaredError {
    constructor({ width, height }) {
      ...
      this.addAbsolute = makeKernel(
        function (prevError, prevLayerErrors) {
  ...
  class BaseLayer {
    ...
    validate() {
      if (Number.isNaN(this.height)) {
        throw new Error(
          `${this.constructor.name} layer height is not a number`
        );
      }
    ...
    reuseKernels(layer) {
      ...
      if (
        layer.hasOwnProperty("predictKernel") &&
        layer.predictKernel !== null
      ) {
    ...
    static toJSON(layer) {
      ...
      return {
        ...
        weights: toUntypedArray(
          weights && weights instanceof gpu_js.Texture
            ? weights.toArray()
            : weights
        ),
  ...
  class Modifier extends BaseLayer {
    ...
    validate() {
      ...
      if (
        this.depth !==
        ((_a = this.inputLayer.depth) !== null && _a !== void 0 ? _a : 0)
      ) {
        throw new Error(
  ...
  class MomentumRootMeanSquaredPropagation extends BasePraxis {
    ...
    run(layer) {
      const { momenta, result } = this.kernelMap(
        layer.weights,
        layer.deltas,
        this.momenta
      );
  ...
  class Convolution extends Filter {
    constructor(settings, inputLayer) {
      ...
      this.weights =
        (_a = settings.weights) !== null && _a !== void 0
          ? _a
          : randos3D(this.width, this.height, this.depth);
      this.deltas = zeros3D(this.width, this.height, this.depth);
      this.biases = values(this.depth, this.bias);
      this.biasDeltas =
        (_b = settings.biasDeltas) !== null && _b !== void 0
          ? _b
          : randos(this.depth);
      this.filters =
        (_c = settings.filters) !== null && _c !== void 0
          ? _c
  ...
  class Dropout extends Filter {
    ...
    predict() {
      ...
      const { result, dropouts } = this.predictKernelMap(
        this.inputLayer.weights
      );
      this.weights = result;
  ...
  function feedForward(settings, input) {
    ...
    return sigmoid$1(
      add$1(multiply$1(weights, input, { praxisOpts }), biases, { praxisOpts }),
      { praxisOpts }
    );
  }
  ...
  function compareFilterDeltas3D(filterDeltas, inputWeights, deltas) {
    ...
    const inputX =
      this.thread.x -
      this.constants.inputWidth *
        (inputY + this.constants.inputHeight * inputZ);
    return (
      filterDeltas[this.thread.y][this.thread.x] +
  ...
  function gru(settings, recurrentInput, input) {
    ...
    const updateGate = sigmoid$1(
      add$1(
        add$1(
          multiply$1(updateGateWeights, input),
          multiply$1(updateGatePeepholes, recurrentInput)
        ),
        updateGateBias
      )
    );
    ...
    const resetGate = sigmoid$1(
      add$1(
        add$1(
          multiply$1(resetGateWeights, input),
          multiply$1(resetGatePeepholes, recurrentInput)
        ),
        resetGateBias
      )
    );
    ...
    const cell = tanh$1(
      add$1(
        add$1(
          multiply$1(cellWeights, input),
          multiply$1(
            cellPeepholes,
            multiplyElement$1(resetGate, recurrentInput)
          )
        ),
        cellBias
      )
    ...
    return add$1(
      ...
      multiplyElement$1(recurrentInput, updateGate)
    );
  }
  ...
  function lstmCell(settings, input, recurrentInput) {
    ...
    const inputGate = sigmoid$1(
      add$1(
        add$1(
          multiply$1(inputGateWeights, input),
          multiply$1(inputGatePeepholes, recurrentInput)
        ),
        inputGateBias
      ),
      { id: "inputGate" }
    ...
    const forgetGate = sigmoid$1(
      add$1(
        add$1(
          multiply$1(forgetGateWeights, input),
          multiply$1(forgetGatePeepholes, recurrentInput)
        ),
        forgetGateBias
      ),
      { id: "forgetGate" }
    ...
    const outputGate = sigmoid$1(
      add$1(
        add$1(
          multiply$1(outputGateWeights, input),
          multiply$1(outputGatePeepholes, recurrentInput)
        ),
        outputGateBias
      ),
      { id: "outputGate" }
    ...
    const memory = tanh$1(
      add$1(
        add$1(
          multiply$1(memoryWeights, input),
          multiply$1(memoryPeepholes, recurrentInput)
        ),
        memoryBias
      ),
      { id: "memory" }
  ...
  function rnnCell(settings, input, recurrentInput) {
    ...
    return relu$1(
      add$1(
        add$1(
          multiply$1(weight, input),
          multiply$1(transition, recurrentInput)
        ),
        bias
      )
    );
  ...
  const defaults$3 = {
    ...
    initPraxis: (layerTemplate, settings) => {
      ...
      return momentumRootMeanSquaredPropagation(
        layerTemplate,
        (_a = layerTemplate.settings.praxisOpts) !== null && _a !== void 0
          ? _a
          : settings
      );
    },
  ...
  class FeedForward {
    ...
    _updateTrainingOptions(opts) {
      ...
      this._setLogMethod(
        (_a = opts.log) !== null && _a !== void 0 ? _a : this.trainOpts.log
      );
      const { callback, callbackPeriod, errorCheckInterval } = this.trainOpts;
      if (callback && callbackPeriod !== errorCheckInterval) {
        console.warn(
          `options.callbackPeriod with value of ${(callbackPeriod !== null &&
          callbackPeriod !== void 0
            ? callbackPeriod
            : "undefined"
          ).toString()} does not match options.errorCheckInterval with value of ${(errorCheckInterval !==
            null && errorCheckInterval !== void 0
            ? errorCheckInterval
            : "undefined"
      ...
      for (let i = 0; i < layers.length; i++) {
        ...
        if (
          ...
          layer.praxis = this.options.initPraxis(
            layer,
            (_b =
              (_a = layer.settings.praxisOpts) !== null && _a !== void 0
                ? _a
                : this.options.praxisOpts) !== null && _b !== void 0
              ? _b
              : {}
          );
    ...
    train(data, options = {}) {
      const { preparedData, status, endTime } = this._prepTraining(
        data,
        options
      );
    ...
    async trainAsync(data, options = {}) {
      ...
      return await new Promise((resolve, reject) => {
        try {
          ...
          const trainPatterns = () => this._trainPatterns(preparedData);
          const thawedTrain = new browser.Thaw(
    ...
    _trainingTick(status, endTime, calculateError, trainPatterns) {
      ...
      if (
        status.iterations >= trainOpts.iterations ||
    ...
    _trainPattern(input, target, logErrorRate) {
      ...
      if (logErrorRate) {
        if (
          !((_a = this._outputLayer) === null || _a === void 0
            ? void 0
            : _a.errors)
        ) {
    ...
    toJSON() {
      ...
      return {
        ...
        sizes:
          (_a = this.options.sizes) !== null && _a !== void 0
            ? _a
    ...
    static fromJSON(json, getLayer) {
      ...
      const inputLayer = getLayer
        ? (_a = layerFromJSON(jsonLayers[0])) !== null && _a !== void 0
          ? _a
          : getLayer(jsonLayers[0])
      ...
      for (let i = 1; i < jsonLayers.length; i++) {
        ...
        if (
          ...
          const layer = getLayer
            ? (_b = layerFromJSON(jsonLayer)) !== null && _b !== void 0
              ? _b
              : getLayer(jsonLayer)
          ...
          const layer = getLayer
            ? (_c = layerFromJSON(jsonLayer, inputLayer)) !== null &&
              _c !== void 0
              ? _c
          ...
          const layer = getLayer
            ? (_d = layerFromJSON(jsonLayer, inputLayer1, inputLayer2)) !==
                null && _d !== void 0
              ? _d
  ...
  function inputOutputObjectsToFloat32Arrays(
    input,
    output,
    inputTable,
    outputTable,
  ...
  class NeuralNetwork {
    constructor(options = {}) {
      ...
      if (inputSize && outputSize) {
        this.sizes = [inputSize]
          .concat(
            hiddenLayers !== null && hiddenLayers !== void 0 ? hiddenLayers : []
          )
          .concat([outputSize]);
      }
    }
    ...
    setActivation(activation) {
      const value =
        activation !== null && activation !== void 0
          ? activation
          : this.trainOpts.activation;
      switch (value) {
        case "sigmoid":
    ...
    addFormat(data) {
      ...
      if (!Array.isArray(data.input) || typeof data.input[0] !== "number") {
        this.inputLookup = lookup.addKeys(
          data.input,
          (_a = this.inputLookup) !== null && _a !== void 0 ? _a : {}
        );
        if (this.inputLookup) {
          this.inputLookupLength = Object.keys(this.inputLookup).length;
        }
      ...
      if (!Array.isArray(data.output) || typeof data.output[0] !== "number") {
        this.outputLookup = lookup.addKeys(
          data.output,
          (_b = this.outputLookup) !== null && _b !== void 0 ? _b : {}
        );
        if (this.outputLookup) {
          this.outputLookupLength = Object.keys(this.outputLookup).length;
        }
    ...
    toJSON() {
      ...
      for (let i = 0; i <= outputLength; i++) {
        jsonLayers.push({
          weights:
            (_a = jsonLayerWeights[i]) !== null && _a !== void 0 ? _a : [],
  ...
  function addBiases(biases, deltas) {
    return (
      ...
      deltas[this.thread.x] * this.constants.learningRate
    );
  }
  ...
  class NeuralNetworkGPU extends NeuralNetwork {
    ...
    calculateTrainingError(data) {
      ...
      release(sum);
      return (result instanceof gpu_js.Texture ? result.toArray() : result)[0];
    }
    adjustWeights() {
      this.getChanges();
      this.changeBiases();
    ...
    buildCalculateDeltas() {
      ...
      calcDeltas = gpu_js.alias(
        gpu_js.utils.getMinifySafeName(() => calcDeltas),
        calcDeltas
      );
    ...
    run(input) {
      ...
      const output =
        outputTextures instanceof gpu_js.Texture
    ...
    toJSON() {
      ...
      const jsonLayerWeights = this.weights.map((layerWeights) => {
        return (
          layerWeights instanceof gpu_js.Texture
      ...
      const jsonLayerBiases = this.biases.map((layerBiases) =>
        Array.from(
          layerBiases instanceof gpu_js.Texture
            ? layerBiases.toArray()
            : layerBiases
        )
      );
  ...
  class Recurrent extends FeedForward {
    ...
    adjustWeights() {
      ...
      for (let i = 0; i < _model.length; i++) {
        _model[i].learn(
          (_a = this.options.learningRate) !== null && _a !== void 0 ? _a : 0
        );
      }
    }
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    ...
    toArray(prop = "weights") {
      ...
      this.iterate({
        ...
        column: (rowIndex, columnIndex) => {
          if (prop === "weights") {
            result[rowIndex][columnIndex] = this.getWeight(
              rowIndex,
              columnIndex
            );
          } else if (prop === "deltas") {
            result[rowIndex][columnIndex] = this.getDelta(
              rowIndex,
              columnIndex
            );
          }
  ...
  class DataFormatter {
    ...
    static fromAllPrintableInputOutput(maxThreshold, values = ["\n"]) {
      const dataFormatter = DataFormatter.fromAllPrintable(
        maxThreshold,
        values
      );
...
var dataFormatter = {
  ...
  toIndexesValue: function ${this.toIndexesValue.toString()},
    ...
    formatDataIn(input, output) {
      ...
      if (
        (_a = this.indexTable) === null || _a === void 0
          ? void 0
          : _a.hasOwnProperty("stop-input")
      ) {
  ...
  class Equation {
    ...
    subtract(left, right) {
      ...
      return this.add(
        this.add(
          this.allOnes(left.rows, left.columns),
          this.cloneNegative(left)
        ),
        right
      );
    }
  ...
  class RNN {
    ...
    initialize() {
      ...
      if (
        dataFormatter === null || dataFormatter === void 0
          ? void 0
          : dataFormatter.characters.length
      ) {
        this.options.inputSize =
          this.options.inputRange =
    ...
    adjustWeights() {
      ...
      for (
        let matrixIndex = 0;
        matrixIndex < allMatrices.length;
        matrixIndex++
      ) {
        ...
        for (let i = 0; i < weights.length; i++) {
          ...
          weights[i] =
            w +
            (-learningRate * r) / Math.sqrt(cache[i] + smoothEps) -
            regc * w;
        }
      }
    ...
    run(rawInput = [], isSampleI = false, temperature = 1) {
      ...
      this.checkRunnable();
      const input =
        this.options.dataFormatter && rawInput.length > 0
    ...
    updateTrainingOptions(options) {
      ...
      this.setLogMethod(
        (_a = options.log) !== null && _a !== void 0 ? _a : this.trainOpts.log
      );
      // TODO: Remove this?
    ...
    prepTraining(data, options) {
      ...
      const endTime =
        Date.now() +
        ((_a = this.trainOpts.timeout) !== null && _a !== void 0 ? _a : 0);
      const status = {
        error: 1,
        iterations: 0,
      };
    ...
    train(data, trainOpts = {}) {
      ...
      const { iterations, errorThresh, logPeriod, callback, callbackPeriod } =
        this.trainOpts;
    ...
    toFunction(cb) {
      ...
      product: ${matrixToString(state.product, i)}
        ...
        if (!usedFunctionNames[fnName]) {
          ...
          innerFunctionsSwitch.push(`        case '${fnName}': //compiled from ${fileName(
            fnName
          )}
...
${innerFunctionsSwitch.join("\n")}
  ...
  class RNNTimeStep extends RNN {
    ...
    createOutputMatrices() {
      ...
      // whd
      const outputConnector = new RandomMatrix(
        outputSize,
        lastHiddenSize,
        0.08
      );
    ...
    runArrayOfArray(input) {
      ...
      this.end();
      return lastOutput !== null && lastOutput !== void 0
        ? lastOutput
        : Float32Array.from([]);
    }
    runObject(input) {
    ...
    formatArrayOfDatumOfObject(data) {
      ...
      for (let i = 0; i < data.length; i++) {
        const datum = data[i];
        result.push(
          inputOutputObjectToFloat32Arrays(datum.input, datum.output)
        );
      }
      return result;
    }
    ...
    formatArrayOfDatumOfArrayOfArray(data) {
      ...
      for (let i = 0; i < data.length; i++) {
        const datum = data[i];
        result.push(
          inputOutputArraysToFloat32Arrays(datum.input, datum.output)
        );
      }
      return result;
    }
      ...
      switch (dataShape) {
        ...
        case "object,number": {
          this.inputLookup = this.outputLookup = lookup.addKeys(
            value,
            (_c = this.inputLookup) !== null && _c !== void 0 ? _c : {}
          );
          if (this.inputLookup) {
        ...
        case "array,object,number": {
          ...
          for (let i = 0; i < typedValue.length; i++) {
            this.inputLookup = this.outputLookup = lookup.addKeys(
              typedValue[i],
              (_d = this.inputLookup) !== null && _d !== void 0 ? _d : {}
            );
            if (this.inputLookup) {
              this.inputLookupLength = this.outputLookupLength = Object.keys(
                this.inputLookup
        ...
        case "datum,array,object,number": {
          ...
          for (let i = 0; i < typedInput.length; i++) {
            this.inputLookup = lookup.addKeys(
              typedInput[i],
              (_e = this.inputLookup) !== null && _e !== void 0 ? _e : {}
            );
            if (this.inputLookup) {
              this.inputLookupLength = Object.keys(this.inputLookup).length;
            }
          ...
          for (let i = 0; i < typedOutput.length; i++) {
            this.outputLookup = lookup.addKeys(
              typedOutput[i],
              (_f = this.outputLookup) !== null && _f !== void 0 ? _f : {}
            );
            if (this.outputLookup) {
              this.outputLookupLength = Object.keys(this.outputLookup).length;
            }
...
${innerFunctionsSwitch.join("\n")}
  ...
  function getNeuralNetworkSizes(net) {
    ...
    if (!sizes) {
      ...
      if (
        hiddenLayers === null || hiddenLayers === void 0
          ? void 0
          : hiddenLayers.some((v) => v < 1)
      ) {
